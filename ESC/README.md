...
- If they can be reduced in terms of privileges
  - If you need to know what the default delegations are, the cmdlet and parameters associated with each role… I will add in the zip file,  the file Dump_RBAC_2019CU12-Sept22.xls. This file contains the default RBAC configuration for a new Exchange 2019 CU 12 organization.
...
- PartConfPerm 
  ...
  - The help with the analysis, and display non standard permissions, add the following Filter 
- isInherited :  False
- User : unchecked
- All servers
